...
<div style="display: flex; gap: 80px; align-items: start; flex-wrap: wrap;">
    <div style="max-width: 250px; text-align: center;">
        <img src="team/manuela.jpg" alt="Manuela Hebel" style="max-width: 250px; border-radius: 50%; object-fit: cover; display: block; margin: 0 auto;">
        <p>
            Manuela Hebel<br>
    ...
    <div style="max-width: 250px; text-align: center;">
        <img src="team/ingo.jpg" alt="Ingo Böhme" style="max-width: 250px; border-radius: 50%; object-fit: cover; display: block; margin: 0 auto;">
        <p>
            Ingo Böhme<br>
    ...
    <div style="max-width: 250px; text-align: center;">
        <img src="team/sebastian.jpg" alt="Sebastian Fichtner" style="max-width: 250px; border-radius: 50%; object-fit: cover; display: block; margin: 0 auto;">
        <p>
